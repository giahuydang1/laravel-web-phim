...
<div class="row container" id="wrapper">
            ...
            <div id="halim_related_movies-2xx" class="wrap-slider">
               ...
               <script>
                  ...
                  owl.owlCarousel({
                     loop: true,margin: 4,autoplay: true,autoplayTimeout: 4000,autoplayHoverPause: true,nav: true,navText: 
                     ['<i class="hl-down-open rotate-left"></i>', '<i class="hl-down-open rotate-right"></i>'],
